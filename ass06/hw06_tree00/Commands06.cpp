...
std::string Commands06::readString(std::ifstream& fin)
{
  int size;
...
void Commands06::writeString(std::ofstream& fout, std::string str)
{
  int size = str.size();
...
void Commands06::loadHashMapCommmands(std::string cmds_filename, std::vector<HashMapCmd>& cmds)
{
...
void Commands06::saveHashMapCommmands(std::string cmds_filename, std::vector<HashMapCmd>& cmds)
{
...
void Commands06::loadHashMapData(std::string filename, std::vector<std::pair<CompositeKey, int> >& data)
{
...
void Commands06::saveHashMapData(std::string filename, std::vector<std::pair<CompositeKey, int> >& data)
{
